 ...
 * {@link StarOfWeekFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link StarOfWeekFragment#newInstance} factory method to
...
public class StarOfWeekFragment extends Fragment {
     ...
     * @return A new instance of fragment StarOfWeekFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static StarOfWeekFragment newInstance(String param1, String param2) {
        StarOfWeekFragment fragment = new StarOfWeekFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        classesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds:dataSnapshot.getChildren()){
                    ...
                    if(classes.getTeacherID().equals(staffId)){
                        ...
                        if(classes.getStarOfTheWeekId().equals("")){
                            name.setText("لا يوجد نجم أسبوع");
                            edit.setText("إضافة");
                        }
                        else {
                            name.setText(classes.getStarOfTheWeekName());
                            edit.setText("تعديل");
                        }
                ...
                if(!found)
                    name.setText("عذرا لا يوجد لديك فصل");
                    ...
                    edit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            fragmentTransaction.replace(R.id.main_frame, new EditStarOfWeekFragment());
